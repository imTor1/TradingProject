...
class RegisterEmailOTPActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_register_email_otpactivity)
        ...
        btnRegisterOTP.setOnClickListener {
            ...
            if (otp.length == 6) {
                ...
                Toast.makeText(this, "กรุณากรอก OTP ให้ครบ 6 หลัก", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@RegisterEmailOTPActivity, message, Toast.LENGTH_SHORT)
                            .show()
                        val intent = Intent(
                            this@RegisterEmailOTPActivity,
                            RegisterCreatePasswordActivity::class.java)
                        ...
                        Toast.makeText(this@RegisterEmailOTPActivity, errorMsg, Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            } catch (e: Exception) {
